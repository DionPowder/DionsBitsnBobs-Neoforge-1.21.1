...
public class StressConfig extends ConfigBase {
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setImpact(double value) {
        return builder -> {
            ...
            ResourceLocation id = DBB.rl(builder.getName());
    ...
    private static void assertFromCreate(BlockBuilder<?, ?> builder) {
        if (!builder.getOwner().getModid().equals(DBB.MOD_ID)) {
            throw new IllegalStateException("Non-DBB blocks cannot be added to Create: Dion's Bits 'n' Bobs! config.");
        }
    }
