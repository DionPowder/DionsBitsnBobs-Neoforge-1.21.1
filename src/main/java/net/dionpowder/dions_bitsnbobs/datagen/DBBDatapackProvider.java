...
public class DBBDatapackProvider extends DatapackBuiltinEntriesProvider {
    ...
    public DBBDatapackProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
