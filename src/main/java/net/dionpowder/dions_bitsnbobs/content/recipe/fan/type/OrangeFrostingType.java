...
public class OrangeFrostingType implements FanProcessingType {
    ...
    public boolean isValidAt(Level level, BlockPos pos) {
        ...
        if (fluidState.getType().builtInRegistryHolder().is(ModTags.Fluids.FAN_PROCESSING_CATALYSTS_ORANGE_FROSTING)) return true;
        var blockState = level.getBlockState(pos);
        return blockState.getBlock().builtInRegistryHolder().is(ModTags.Blocks.FAN_PROCESSING_CATALYSTS_ORANGE_FROSTING);
    }
    ...
    public boolean canProcess(ItemStack stack, Level level) {
        ...
        return recipeManager
                .getRecipeFor(ModRecipeTypes.ORANGE_FROSTING.getType(), input, level)
                .isPresent();
    }
