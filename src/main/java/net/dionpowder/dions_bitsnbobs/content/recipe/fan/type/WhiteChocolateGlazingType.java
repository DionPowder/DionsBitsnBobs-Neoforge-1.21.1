...
public class WhiteChocolateGlazingType implements FanProcessingType {
    ...
    public boolean isValidAt(Level level, BlockPos pos) {
        ...
        return blockState.getBlock().builtInRegistryHolder().is(DBBTags.Blocks.FAN_PROCESSING_CATALYSTS_WHITE_CHOCOLATE_GLAZING);
    }
    ...
    public boolean canProcess(ItemStack stack, Level level) {
        ...
        return recipeManager
                .getRecipeFor(DBBRecipeTypes.WHITE_CHOCOLATE_GLAZING.getType(), input, level)
                .isPresent();
    }
