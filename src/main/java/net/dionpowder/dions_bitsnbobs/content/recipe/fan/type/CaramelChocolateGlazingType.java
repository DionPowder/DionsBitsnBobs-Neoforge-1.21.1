...
public class CaramelChocolateGlazingType implements FanProcessingType {
    ...
    public boolean isValidAt(Level level, BlockPos pos) {
        ...
        if (fluidState.getType().builtInRegistryHolder().is(DBBTags.Fluids.FAN_PROCESSING_CATALYSTS_CARAMEL_CHOCOLATE_GLAZING)) return true;
        var blockState = level.getBlockState(pos);
        return blockState.getBlock().builtInRegistryHolder().is(DBBTags.Blocks.FAN_PROCESSING_CATALYSTS_CARAMEL_CHOCOLATE_GLAZING);
    }
    ...
    public boolean canProcess(ItemStack stack, Level level) {
        ...
        return recipeManager
                .getRecipeFor(DBBRecipeTypes.CARAMEL_CHOCOLATE_GLAZING.getType(), input, level)
                .isPresent();
    }
