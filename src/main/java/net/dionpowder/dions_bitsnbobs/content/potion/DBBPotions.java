...
public class DBBPotions {
    public static final DeferredRegister<Potion> POTIONS =
            DeferredRegister.create(BuiltInRegistries.POTION, DBB.MOD_ID);

    public static final Holder<Potion> SUGAR_RUSH_POTION = POTIONS.register("sugar_rush_potion",
            () -> new Potion(new MobEffectInstance(DBBEffects.SUGAR_RUSH_EFFECT, 1800, 0)));
